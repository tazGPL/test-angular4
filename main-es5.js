...
module.exports = "<nav class=\"navbar bg-primary\">\n    <ul class=\"nav nav-pills\">\n        <li class=\"nav-item\">\n            <a\n            routerLink=\"/\"\n            routerLinkActive=\"bg-danger\"\n            [routerLinkActiveOptions]=\"{ exact: true }\"\n            class=\"nav-link text-white\">Strona główna</a>\n        </li>\n        <li>\n            <a routerLink=\"/404\" routerLinkActive=\"bg-danger\" class=\"nav-link text-white\">Strona 404</a>\n        </li>\n    </ul>\n</nav>"
...
module.exports = "<div  class=\"card m-3\" style=\"width: 18rem;\" appHighlight>\n    <img\n        *ngIf=\"post.images\"\n        [src]=\"post.images[0]\" class=\"card-img-top\" alt=\"...\">\n    <div class=\"card-body\">\n      <h5 class=\"card-title\">{{ post.author.name }}</h5>\n      <p class=\"card-text\">\n          {{ post.body }}\n      </p>\n    </div>\n  </div>"
...
var HomePageComponent = /** @class */ (function () {
    ...
    HomePageComponent.prototype.setupPosts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.postsService.getPosts()];
                    case 1:
                        _a.posts = _b.sent();
                        return [2 /*return*/];
                }
...
module.exports = __webpack_require__(/*! C:\Users\NP19\facebook\src\main.ts */"./src/main.ts");
